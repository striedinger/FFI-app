			...
			<div class="panel-body">
				<div class="col-sm-12 col-md-12">
					<div class="form-group">
						<label>Empresa</label>
							<p><a href="{{ url('/companies/view') . '/' . $acap->company->id }}">{{ $acap->company->name }}</a></p>
					</div>
					<form method="POST">
    								...
    								<table class="table table-striped">
										...
										<tbody>
											...
											<tr>
												...
												<td width="40%">
													@for($j=1;$j<=7;$j++)
													<label class="radio-inline"><input type="radio" name="{{ 'p' . $i }}" value="{{ $j }}" @if($j==$acap['p' . $i]) checked @endif> {{ $j }}</label>
													@endfor
												</td>
											</tr>
											@endfor
