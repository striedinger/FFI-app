                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade in active" id="section1">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="p1" value="{{ $company->name }}" placeholder="Nombre de la Empresa" readonly>
                                        @if ($errors->has('p1'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="p2" value="{{ $company->nit }}" placeholder="Numero de Identificación Tributaria" readonly>
                                        @if ($errors->has('p2'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <label>
                                            <input type="radio" name="p4" value="Si" checked> Si &nbsp;</label>
                                        <label>
                                            <input type="radio" name="p4" value="No"> No</label>
                                        @if ($errors->has('p4'))
                                        <span class="help-block">
                                ...
                                <div class="tab-pane fade" id="section2">
                                    <div class="form-group">
                                        <label>Nombre</label>
                                        <input class="form-control" name="p6" value="{{ Auth::user()->name }}" placeholder="Nombre">
                                        @if ($errors->has('p6'))
                                        <span class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="p9" value="{{ Auth::user()->phone }}" placeholder="Telefono">
                                        @if ($errors->has('p9'))
                                        <span class="help-block">
                                    ...
                                    <div class="form-group">
                                        <label>E-mail</label>
                                        <input class="form-control" name="p10" value="{{ Auth::user()->email }}" placeholder="E-mail" readonly>
                                        @if ($errors->has('p10'))
                                        <span class="help-block">
                                ...
                                <div class="tab-pane fade" id="section3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <label>
                                            <input type="radio" name="p13" value="Aumentado" checked> Aumentado &nbsp;</label>
                                        <label>
                                            <input type="radio" name="p13" value="Disminuido"> Disminuido &nbsp;</label>
                                        <label>
                                            <input type="radio" name="p13" value="Se han mantenido constantes"> Se han mantenido constantes</label>
                                        @if ($errors->has('p13'))
                                        <span class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <label>
                                            <input type="radio" name="p14" value="Si" checked> Si &nbsp;</label>
                                        <label>
                                            <input type="radio" name="p14" value="No"> No</label>
                                        @if ($errors->has('p14'))
                                        <span class="help-block">
                                ...
                                <div class="tab-pane fade" id="section4">
                                                        ...
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p17" value="1"></label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p18" value="1"></label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                ...
                                                                <input type="hidden" name="p19" value="0">
                                                                    <input type="checkbox" name="p19" value="1"></label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="checkbox-inline">
                                            ...
                                            <input type="checkbox" name="p20" value="1">Abandonada</label>
                                        <label class="checkbox-inline">
                                            <input type="hidden" name="p21" value="0">
                                            <input type="checkbox" name="p21" value="1">Aún en marcha al final del año 2015</label>
                                    </div>
                                </div>
                                <!-- Seccion 5-->
                                                        ...
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p22" value="1"></label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p23" value="1"></label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p24" value="1"></label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                        ...
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p25" value="1"></label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p26" value="1"></label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p27" value="1"></label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                        ...
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p28" value="1"></label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p29" value="1"></label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p30" value="1"></label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p31" value="1"></label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                        ...
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p32" value="1"></label>
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="checkbox">
                                                        ...
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p34" value="1"></label>
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p35" value="1"></label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p36" value="1"></label>
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p37" value="1"></label>
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p38" value="1"></label>
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p39" value="1"></label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p40" value="1"></label>
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="checkbox">
                                                        ...
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p42" value="1"></label>
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p43" value="1"></label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p44" value="1"></label>
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="checkbox">
                                                        ...
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p46" value="1"></label>
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p47" value="1"></label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p48" value="1"></label>
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="checkbox">
                                                        ...
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p50" value="1"></label>
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p51" value="1"></label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p52" value="1"></label>
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p53" value="1"></label>
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p54" value="1"></label>
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p55" value="1"></label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p56" value="1"></label>
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p57" value="1"></label>
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p58" value="1"></label>
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p59" value="1"></label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p60" active="1"></label>
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p61" value="1"></label>
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p62" value="1"></label>
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p63" value="1"></label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p64" value="1"></label>
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p65" value="1"></label>
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p66" value="1"></label>
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="p67" active="1"></label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
