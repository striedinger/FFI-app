                                ...
                                <div class="tab-pane fade" id="section3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="p11">
                                            ...
                                            <option value="{{ $sector['rev'] }}" @if($icai->p11==$sector['rev'])selected @endif>{{ $sector['rev'] . ' - ' . $sector['desc'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                                        ...
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="41" value="1" @if($icai->p41=="1") checked @endif></label>
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="checkbox">
                                                        ...
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="45" value="1" @if($icai->p45=="1") checked @endif></label>
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="checkbox">
                                                        ...
                                                        <td align="center">
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <input type="checkbox" name="49" value="1" @if($icai->p49=="1") checked @endif></label>
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="checkbox">
